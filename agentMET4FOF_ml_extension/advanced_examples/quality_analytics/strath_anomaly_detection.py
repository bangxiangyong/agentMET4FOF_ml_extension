...
from agentMET4FOF_ml_extension.util.plot_samples import plot_time_series_samples
...
def main():
    ...
    # minmax_agent = agentNetwork.add_agent(name="MinMaxScaler_local",
    #                                       agentType=ML_TransformAgent,
    #                                       model=apply_along_sensor,
    #                                       func=minmax_scale_local,
    #                                       sensor_axis = 1,
    #                                       send_test_samples = True,
    #                                       )
    ...
    plotting_samples_agent = agentNetwork.add_agent(agentType=ML_PlottingAgent,
                                                    model=plot_time_series_samples,
                                                    nrows = 4,
                                                    ncols = 5,
                                                    )
    ...
    # plot samples
    # fft_agent.bind_output(plotting_samples_agent, channel=["test_samples"])
    minmax_agent.bind_output(plotting_samples_agent, channel=["test_samples"])
    datastream_agent.bind_output(plotting_samples_agent, channel=["metadata"])
    plotting_samples_agent.bind_output(monitor_agent, channel=["plot"])
